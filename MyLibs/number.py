...
class Number:
	def __init__(self, npoints, universe_size, region_min, region_max, number):
		self.number = Region(name='number_'+str(number), npoints=npoints, universe_size=universe_size, region_min=region_min, region_max=region_max, region_type='triangular', centered=number)
	...
	def add(self, number):
		...
		new_number = (self.number.region_center + number.number.region_center)
